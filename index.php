...
function get_temperature() {
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => "https://www.bing.com/search?q=m%C3%A9t%C3%A9o+$ville&form=QB                                                                             LH&sp=-1&ghc=1&lq=0&pq=m%C3%A9t%C3%A9o+$ville&sc=10-14&qs=n&sk=&cvid=A94421AB031                                                                             B43C3A6CFA2FAE6ECAAFC&ghsh=0&ghacc=0&ghpl=",
  ...
  $response = stristr($response, '<div class="wtr_currTemp b_focusTextLarge" dat                                                                             a-val="'); //Récupération de la portion de code
